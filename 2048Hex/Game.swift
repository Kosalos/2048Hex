...
let backgroundColor = UIColor.init(red:0.2, green:0.4, blue:0.1, alpha:1)
...
let cellColors:[UIColor] = [
    UIColor.init(red:c0, green:c1, blue:c0, alpha:1),    // 2
    UIColor.init(red:c3, green:c2, blue:c0, alpha:1),    // 4
    UIColor.init(red:c0, green:c3, blue:c0, alpha:1),    // 8
    UIColor.init(red:c0, green:c1, blue:c1, alpha:1),    // 16
    UIColor.init(red:c0, green:c1, blue:c2, alpha:1),    // 32
    UIColor.init(red:c0, green:c1, blue:c3, alpha:1),    // 64
    UIColor.init(red:c1, green:c1, blue:c1, alpha:1),    // 128
    UIColor.init(red:c1, green:c1, blue:c2, alpha:1),    // 256
    UIColor.init(red:c2, green:c1, blue:c3, alpha:1),    // 512
    UIColor.init(red:c2, green:c1, blue:c3, alpha:1),    // 1024
    UIColor.init(red:c3, green:c1, blue:c3, alpha:1),    // 2048
]

func cellColor(_ value:Int) -> CGColor {
    if value == EMPTY { return UIColor.gray.cgColor }
...
class Game {
    ...
    func startShadow() {
        context!.saveGState()
        context?.setShadow(offset: CGSize(width:3, height:-3), blur:3, color: UIColor.black.cgColor)
    }
    ...
    func drawScore() {
        ...
        drawText(20,540,str,36,.yellow,0)
